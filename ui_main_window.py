...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.image_label.setText(_translate("Form", "Select Stream"))
        self.control_bt.setText(_translate("Form", "Camera 0"))
        self.control_bt1.setText(_translate("Form", "Camera 1"))
        self.control_bt2.setText(_translate("Form", "Camera 2"))
